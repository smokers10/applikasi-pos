                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-primary btn-sm" data-type="create" onclick="openCRUDModal(this)">Tambah kategori Baru</button>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        <td>{{$category->name}}</td>
                                        <td>
                                            <button class="btn btn-success" data-type="edit" detail='{{$category}}' onclick="openCRUDModal(this)"><i class="fas fa-edit"></i></button>
                                            <button class="btn btn-danger" data-type="delete" detail='{{$category}}' onclick="openCRUDModal(this)"><i class="fas fa-trash"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    ...
    function openCRUDModal(el) {
        ...
        if (type == "delete") {
            ...
            $("#deleting").show()
            $("#createupdate").hide()
            $("#modal-title").text("Hapus Data Kategori")
            return
        }
    }
    ...
    function update(data) {
        $.ajax({
            ...
            beforeSend: function(){
                ...
                $("#swal-content").text('Sedang Update Kategori')
            },
    ...
    function create(data) {
        $.ajax({
            ...
            beforeSend: function(){
                ...
                $("#modal-swal").modal('show')
                $("#swal-title").text("Mohon Tunggu")
                $("#swal-content").text('Sedang Membuat Kategori Baru')
            },
            success: function(res){
    ...
    function deleteItem(data) {
        $.ajax({
            ...
            beforeSend: function(){
                ...
                $("#modal-swal").modal('show')
                $("#swal-title").text("Mohon Tunggu")
                $("#swal-content").text('Sedang Menghapus Kategori')
            },
            success: function(res){
